...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Antes de marcar sua sessão,',
  headingEm: 'assista esses 60 segundos.',
  preText: 'Eu gravei isso pra você entender, em 1 minuto, como o Método TEN trabalha quebra de padrão emocional na prática. Sem discurso bonito, sem promessa de prazo. Só pra você decidir se faz sentido continuar.',
  postText: 'Se chegou até aqui é porque já reconheceu o padrão. Agora deixa eu te contar como o trabalho acontece.',
}
            ...
            >
              <AnimatePresence mode="wait">
                {!playing ? (
                  ...
                  >
                    {/*
                      O player embed do YouTube faz pillarbox (barras pretas laterais)
                      em vídeo vertical. scale() amplia o iframe dentro do card
                      (overflow:hidden) cortando as barras — fica full-bleed.
                    */}
                    <iframe
