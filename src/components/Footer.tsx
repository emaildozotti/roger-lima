...
const COPY = {
  ...
  heading: 'Se você chegou até aqui, é porque já reconheceu o padrão.',
  headingEm: 'O próximo passo é conversar.',
  subtitle: 'Conversa inicial pelo WhatsApp. Sem compromisso, sem cobrança nesse primeiro contato.',
  ctaText: 'Falar com o Roger no WhatsApp',
}
// ════════════════════════════════════════════════════════════════════
