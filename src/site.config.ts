// ════════════════════════════════════════════════════════════════════
// DADOS DO CLIENTE — UNICO ARQUIVO DE CONFIGURACAO
// Fonte: briefing-structured.json + lp-copy.md (CTA texts)
// ════════════════════════════════════════════════════════════════════

export const SITE = {
  nomeCompleto: 'Roger de Melo Lima',
  nomeCurto: 'Roger',
  iniciais: 'RL',
  especialidadeCurta: 'Regulação Emocional e Autonomia',
  credenciais: 'Terapeuta Integrativo | Método TEN\nDiploma MEC previsto pra junho/2026',
  crp: 'Em formação no Método TEN',
